      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-sm rounded-2xl bg-white shadow-2xl px-6 py-8 text-center"
          ...
          >
            ...
            <button
              type="button"
              onClick={onConfirm}
              className="w-full px-6 py-4 rounded-xl text-white text-lg font-semibold shadow-lg active:translate-y-px transition-transform"
